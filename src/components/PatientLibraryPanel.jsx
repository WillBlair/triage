...
export default function PatientLibraryPanel({ onOpenPatientDetail, doctorId }) {
  const [query, setQuery] = useState('')
  const { allPatients, loading } = usePatients(doctorId)
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col gap-3">
      {loading ? (
        <div className="flex flex-1 items-center justify-center text-sm text-slate-400">Loading patients…</div>
      ) : (
